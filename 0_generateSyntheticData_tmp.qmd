...
#save the data to data-synthetic as RDS
saveRDS(panel_balanced, "data-synthetic/panel_balanced.rds")
```
...
# export the data to data-synthetic as RDS
saveRDS(diary_tibble_sampled, "data-synthetic/diary_balanced.rds")
```
...
# save the data to data-synthetic as RDS
saveRDS(sampled_tibble, "data-synthetic/steam_balanced.rds")
```
...
# save the data to data-synthetic as RDS
saveRDS(sampled_tibble, "data-synthetic/nintendo_balanced.rds")
