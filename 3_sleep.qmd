...
p_load(tidyverse, lme4, marginaleffects, glmmTMB, mice, ordinal, modelsummary, lubridate)
...
data.panel <- read.csv("data-synthetic/synPanelClean.csv") |> # requires that the preprocessing script has been run
