...
data.nin <- read_csv("data-synthetic/synNintendo.csv")
data.xbox <- read_csv("data-synthetic/synXbox.csv")
data.steam <- read_csv("data-synthetic/synSteam.csv")
data.android <- read_csv("data-synthetic/synAndroid.csv")
data.ios <- read_csv("data-synthetic/syniOS.csv")
