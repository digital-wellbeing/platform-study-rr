...
```{r}
#| label: opts
#| code-summary: "Show the code (options)"
...
write_csv(synNintendoClean, "data-synthetic/synNintendoClean.csv")
write_csv(synXboxClean, "data-synthetic/synXboxClean.csv")
write_csv(synSteamClean, "data-synthetic/synSteamClean.csv")
```
