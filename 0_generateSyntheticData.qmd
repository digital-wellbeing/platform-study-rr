...
p_load(
  tidyverse, jsonlite, qualtRics, sjlabelled, hms, openxlsx
)
```
...
min_val <- min(synPanel$`psqi_4#1_1_1`, na.rm = TRUE)
max_val <- max(synPanel$`psqi_4#1_1_1`, na.rm = TRUE)
# Rescale the values to be between 0 and 12
synPanel$`psqi_4#1_1_1` <- (synPanel$`psqi_4#1_1_1` - min_val) / (max_val - min_val) * 12
# Calculate the minimum and maximum values of the column
min_val <- min(synPanel$`psqi_4#1_1_2`, na.rm = TRUE)
max_val <- max(synPanel$`psqi_4#1_1_2`, na.rm = TRUE)
# Rescale the values to be between 0 and 12
synPanel$`psqi_4#1_1_2` <- (synPanel$`psqi_4#1_1_2` - min_val) / (max_val - min_val) * 60
```
...
# Export as RDS
saveRDS(synIntake, "data-synthetic/synIntake.rds")
saveRDS(synDiary, "data-synthetic/synDiary.rds")
saveRDS(synPanel, "data-synthetic/synPanel.rds")
saveRDS(synXbox, "data-synthetic/synXbox.rds")
saveRDS(synNintendo, "data-synthetic/synNintendo.rds")
saveRDS(synAndroid, "data-synthetic/synAndroid.rds")
saveRDS(synSteam, "data-synthetic/synSteam.rds")
saveRDS(syniOS, "data-synthetic/syniOS.rds")
```
